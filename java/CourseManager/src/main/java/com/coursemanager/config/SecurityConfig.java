    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/courses/**", "/api/categories/**", "/api/instructors/**", "/api/enrollments/**", "/api/shares/**").hasAnyRole("ADMIN", "FULL_USER")
                        .requestMatchers(HttpMethod.PUT, "/api/courses/**", "/api/categories/**", "/api/instructors/**", "/api/enrollments/**", "/api/shares/**").hasAnyRole("ADMIN", "FULL_USER")
                        .requestMatchers(HttpMethod.DELETE, "/api/courses/**", "/api/categories/**", "/api/instructors/**", "/api/enrollments/**", "/api/shares/**").hasAnyRole("ADMIN", "FULL_USER")
